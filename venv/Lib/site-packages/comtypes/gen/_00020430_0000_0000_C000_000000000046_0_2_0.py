...
__all__ = [ 'OLE_YPOS_HIMETRIC', 'OLE_XPOS_CONTAINER', 'VgaColor',
           'StdPicture', 'StdFont', 'Default', 'OLE_YSIZE_PIXELS',
           'FONTNAME', 'Gray', 'OLE_YPOS_CONTAINER', 'Checked',
           'OLE_COLOR', 'FontEvents', 'OLE_XSIZE_PIXELS', 'FONTSIZE',
           'Font', 'OLE_XPOS_PIXELS', 'OLE_HANDLE', 'Monochrome',
           'OLE_OPTEXCLUSIVE', 'IFontEventsDisp', 'FONTBOLD',
           'OLE_ENABLEDEFAULTBOOL', 'IPictureDisp', 'IFont',
           'Picture', 'OLE_YPOS_PIXELS', 'Color', 'FONTSTRIKETHROUGH',
           'FONTITALIC', 'OLE_YSIZE_CONTAINER', 'OLE_CANCELBOOL',
           'IFontDisp', 'OLE_TRISTATE', 'FONTUNDERSCORE',
           'OLE_XSIZE_CONTAINER', 'Unchecked', 'LoadPictureConstants',
